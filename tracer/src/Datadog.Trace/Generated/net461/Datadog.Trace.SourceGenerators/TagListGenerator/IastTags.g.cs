...
namespace Datadog.Trace.Iast
{
    partial class IastTags
    {
        ...
        // IastMetaStructTagSizeExceededBytes = MessagePack.Serialize("_dd.iast.json.meta-struct.size.exceeded");
        private static ReadOnlySpan<byte> IastMetaStructTagSizeExceededBytes => new byte[] { 217, 39, 95, 100, 100, 46, 105, 97, 115, 116, 46, 106, 115, 111, 110, 46, 109, 101, 116, 97, 45, 115, 116, 114, 117, 99, 116, 46, 115, 105, 122, 101, 46, 101, 120, 99, 101, 101, 100, 101, 100 };
        ...
        public override string? GetTag(string key)
        {
            return key switch
            {
                ...
                "_dd.iast.json.meta-struct.size.exceeded" => IastMetaStructTagSizeExceeded,
        ...
        public override void SetTag(string key, string value)
        {
            switch(key)
            {
                ...
                case "_dd.iast.json.tag.size.exceeded": 
                    ...
                    break;
                case "_dd.iast.json.meta-struct.size.exceeded": 
        ...
        public override void EnumerateTags<TProcessor>(ref TProcessor processor)
        {
            ...
            {
                processor.Process(new TagItem<string>("_dd.iast.json.meta-struct.size.exceeded", IastMetaStructTagSizeExceeded, IastMetaStructTagSizeExceededBytes));
            }
        ...
        protected override void WriteAdditionalTags(System.Text.StringBuilder sb)
        {
            ...
            if (IastMetaStructTagSizeExceeded is not null)
            {
                sb.Append("_dd.iast.json.meta-struct.size.exceeded (tag):")
